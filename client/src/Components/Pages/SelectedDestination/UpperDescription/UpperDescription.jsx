    ...
    <div>
      <div className="headerimg">
        <div className="subimg">
          <img
            ...
            src="https://img.cdn.zostel.com/zostel/gallery/images/kR55bIDpRYC-2wYqnlT6jA/manali-20201112102605.jpg?w=946"
            alt=""
          />
        </div>
        <div className="subgp">
          <div>
            <img
              src="https://img.cdn.zostel.com/zostel/gallery/images/x7JkdsaZR-Se_PPX0NBN2g/manali-exterior-full-20201105110532.jpg?w=410"
              alt=""
              className="subgp1"
            />
          </div>
          <div>
            <img
              src="https://img.cdn.zostel.com/zostel/gallery/images/2B_i6AW9RTaNmY6d-2Bcmw/manali-board-20201105110533.jpg?w=410"
              alt=""
              className="subgp2"
            />
          </div>
          <div>
            <img
              src="https://img.cdn.zostel.com/zostel/gallery/images/15R001HDS2Cc_wCv97eAPQ/manali-garden-cafe-20201105110535.jpg?w=410"
              alt=""
              className="subgp3"
            />
            <img
              ...
              src="https://zostel-clone-kerrybli.vercel.app/static/media/viewPhoto.a3dbed0d.svg"
              alt=""
            />
          </div>
        </div>
      ...
      >
        <div style={{ marginLeft: "6%" }}>
          <h1
            style={{ color: "#f15824", fontSize: "36px", lineHeight: "54px" }}
          >
            Zostel Shimla (KOTKHAI)
          </h1>
          ...
          <div id="final" style={{ display: "none" }}>
            ...
            <Button type="button" onClick={handleShowv1}>
              Show less
            </Button>
          </div>
        </div>
        ...
        >
          ...
          <ul style={{ listStyleType: "none", marginRight: "10px" }}>
            ...
            <li>
              <MdWifi style={{ width: "20px", height: "25px" }} />
              <span
                style={{
                  color: "#4d585b",
                  paddingBottom: "15px",
            ...
            <li>
              <MdRoomService style={{ width: "20px", height: "25px" }} />
              <span
                style={{
                  color: "#4d585b",
                  paddingBottom: "15px",
            ...
            <li>
              <MdSportsEsports style={{ width: "20px", height: "25px" }} />
              <span
                style={{
                  color: "#4d585b",
                  paddingBottom: "15px",
            ...
            <li>
              <MdFreeBreakfast style={{ width: "20px", height: "25px" }} />
              <span
                style={{
                  color: "#4d585b",
                  paddingBottom: "15px",
          ...
          <ul style={{ listStyleType: "none", marginRight: "10px" }}>
            ...
            <li>
              <VscVm style={{ width: "20px", height: "25px" }} />
              <span
                style={{
                  color: "#4d585b",
                  paddingBottom: "15px",
              ...
              >
                &nbsp;<strong> Common Television</strong>
              </span>
            </li>
            <li>
              <MdCasino style={{ width: "20px", height: "25px" }} />
              <span
                style={{
                  color: "#4d585b",
                  paddingBottom: "15px",
            ...
            <li>
              <HiLightBulb style={{ width: "20px", height: "25px" }} />
              <span
                style={{
                  color: "#4d585b",
                  paddingBottom: "15px",
            ...
            <li>
              <MdLuggage style={{ width: "20px", height: "25px" }} />
              <span
                style={{
                  color: "#4d585b",
                  paddingBottom: "15px",
          ...
          <ul style={{ listStyleType: "none", marginRight: "10px" }}>
            <li>
              ...
              >
                &nbsp;<strong> Laundry Services (Extra)</strong>
              </span>
            </li>
            <li>
              <MdLocalDrink style={{ width: "20px", height: "25px" }} />
              <span
                style={{
                  color: "#4d585b",
                  paddingBottom: "15px",
            ...
            <li>
              <MdRestaurant style={{ width: "20px", height: "25px" }} />
              <span
                style={{
                  color: "#4d585b",
                  paddingBottom: "15px",
            ...
            <li>
              <MdBathtub style={{ width: "20px", height: "25px" }} />
              <span
                style={{
                  color: "#4d585b",
                  paddingBottom: "15px",
            ...
            <li>
              <MdLayers style={{ width: "20px", height: "25px" }} />
              <span
                style={{
                  color: "#4d585b",
                  paddingBottom: "15px",
