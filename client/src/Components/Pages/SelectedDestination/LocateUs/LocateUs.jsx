    ...
    return <>
        <div className="locate-us-container">
            <div className="locate-us-parent">
                <div className='heading'> <h3 className='common-heading'>Locate Us</h3></div>
                <div className='address-parent-div'>
                    <div className='address-info-div'>
                        <div className='title-comman'>
                            Address:
                        </div>
                        <div>
                        ...
                        <div>
                            <span className='title-comman'>Contact: </span> <a className='number' href="tel:02248962265"><span >02248962265</span></a>
                        </div>
                        <div className='whatapp-direction-div'>
                            <div className='whatsapp-btn'>
                                <a className='tst' href="https://api.whatsapp.com/send?phone=919289229822&text=Hi%20Zostel" target="blank_">
                                    <FontAwesomeIcon icon={faWhatsapp} ></FontAwesomeIcon> WhatsApp Us
                                </a>
                            </div>
                            <div>
                                <div onClick={() => {
                                    ...
                                    <span className='Direction-heading'>Directions</span> <span><FontAwesomeIcon className='downarroy' icon={faArrowDown} ></FontAwesomeIcon></span>
                                </div>
                                <div className='direction-details'>
                                    <div style={!wrap ? { display: 'none' } : { display: 'block', border: "1px solid #e1e1eb" }} >
                                        <p className='dir-details-txt'>
                                            Located in Old Manali, which is at a distance of 3 km from the very popular Manali town, our hostel can be reached by taking in a taxi or a tuk-tuk from Manali. The hostel is located on the far end of old Manali village and getting here can be an experience in itself. Upon reaching Old Manali, at the main Old Manali Road, also known as Manu Temple Road, the property is 200 m from the extremely popular Drifters' cafe. Those travelling by private vehicles can park their cars at the parking close to the cafe. We would be absolutely glad to guide you from the same place, so don't hesitate in giving us a call. Or even simply, take the lane on the right next to cafe Bean and Gone and in 200 m, which would include passing by a volleyball court and narrow village roads, you'll reach Zostel Manali.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div className='getdirection-btn'>
                                <a href="https://www.google.com/maps/dir/?api=1&destination=32.256084,77.178838" target="blank_">
                    ...
                    <div className='address-map-div'>
                        <div>
                            <img className='map-image' src="https://www.linkpicture.com/q/Screenshot-19_5.png" alt="" />
                        </div>
                    </div>
                </div>
                <div className='policy-div'>
                    <div className='colid-policy-div div-seperator'>
                        <div><h3 className='common-heading'>COVID Policy</h3></div>
                    ...
                    <div className='property-policy-div div-seperator'>
                        <div><h3 className='common-heading'>Property Policy</h3></div>
                        <div className='title-seperator'>
                    ...
                    <div className='cancellation-policy-div div-seperator'>
                        <div><h3 className='common-heading'>Cancellation Policy</h3></div>
                        <div className='title-seperator'>
