...
export const PreSelDestination = () => {
  ...
  const typeOfZostel = [
    ...
    },
    {
      ...
      description:
        "Boasting a bar, a garden as well as a terrace, Zostel Homes Shuru is situated in Manāli, within 6 km of Hidimba Devi Temple and 5 km of Tibetan Monastery.",
      image:
        "https://img.cdn.zostel.com/zostel/gallery/images/nBB732AKQAKxMvBy8uOuLw/shuru-manali-20201112105524.jpg?w=700",
      price: "4499",
    },
    {
                ...
                <>
                  <div className="s-p-destination">
                    ...
                    <div className="s-p-right">
                      ...
                      <div className="s-p-d-view">
                        <span className="s-p-d-price">
                          Starting from ₹{el.price}
                        </span>
                        <span className="s-p-d-view-btn-container">
                          <button
                            onClick={navigteToDest}
                            className="s-p-d-view-btn"
                          >
                            {"view ->"}
                          </button>
                        </span>
                    ...
                    <div className="l-r-blog-info-rapper">
                      <div className="l-r-blog-info">
                        ...
                        <div className="l-r-blod-logo-pName-container">
                          <span>
                            <img
                              className="l-r-blog-person-logo"
                              src="https://th.bing.com/th/id/R.f47072744c7be1e77b4e83c730069e6f?rik=Vxna0Aj42Z%2fUaA&riu=http%3a%2f%2fwww.clker.com%2fcliparts%2fZ%2fQ%2f1%2fQ%2f9%2fP%2fzombie-red-hi.png&ehk=kANqMDyeHa9lcgl0qPWongrlqYsDEbMNCAjNdyB%2fQUQ%3d&risl=&pid=ImgRaw&r=0"
                              alt=""
                            />
                          </span>
                          <span className="l-r-blog-person-name">
                            {el.name}
                          </span>
                        </div>
                      </div>
          ...
          <div className="m-about-div">
            ...
            <div className="m-about-d">
              <p className="m-upper-d">
                Enthralling mountain views, snowfall in winters, cafes enhancing
                your leisure time, and a bundle of different experiences for
                travellers: what else could you possibly need from a mountain
                getaway? Pampering backpackers with fine hikes, travellers
              </p>
              <div
                style={showHide ? { display: "block" } : { display: "none" }}
                className="m-hide-unhide"
              >
                <p>
                ...
                <p>
                  ...
                  these, Jogini Waterfall Trek, Hampta Pass Trek, Patalsu Peak,
                  Parashar lake are some of the famous ones.
                </p>
                <p>
                  The river Beas runs through this town, making every turn and
                  narrow climb blissful. Soak your feet and submit to the cold
                  waters of the river for hours at a time. And the best part,
                  you won't have to go far for it.
                </p>
                <h3 className="m-d-heading">Fun facts</h3>
                <p>
                  The town is named after saint Manu, who came here to meditate
                  and re-create human life after it was tragically washed out in
                  the great Himalayan floods. The saint is a local legend and
                ...
                <p>
                  ...
                  peach, and apricot trees bloom, painting the town delicate and
                  mesmerising.
                </p>
                <p>
              ...
              <div className="m-set-hide-unhide" onClick={handleShowHide}>
