...
export const Details = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (fdata.address.length <= 10 && fdata.agree === true && fdata.email.length <= 5 && fdata.firstname.length <= 5 && fdata.lastname.length <= 5) {
            return
        }
    }
        ...
        <>
            <div className='info-main-wrapper'>
                <div className="heading">
                    <img style={{ marginTop: "20px", marginBottom: "10px", marginRight: "5px" }} src="https://zostel-clone-kerrybli.vercel.app/BackArrow.svg" alt="Back" />
                ...
                <section className='info-top-cont'>
                    ...
                    <div className="right" style={{ width: '300px' }}>
                        <div className='title' style={{}}>
                            <h4>Summary</h4>
                            <p>1 night <span>staring from </span></p>
                        </div>
                        ...
                        <div className='total'><h5>Total (tax incl.)</h5><p>₹ price</p></div>
                        <div className='pay'><h5>Payable Now</h5><p>₹ price</p></div>
                        <div className='agree'>
